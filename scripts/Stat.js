...
var splittertext = "[^\\u00BF-\\u1FFF\\u2C00-\\uD7FF\\w]+";

var splitter = new RegExp(splittertext);
var beginSplit = new RegExp("^"+splittertext);
var endSplit = new RegExp(splittertext+"$");


///////////////////////// the Stat class ///////////////////////////
////////////////////////////////////////////////////////////////////

function Stat(sectionArray, specific)
{
